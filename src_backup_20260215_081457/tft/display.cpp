...
// Optional font support - place fonts in resources/fonts/
// To use: copy font file from resources/fonts/ and enable below
...
#else
    tft.setTextSize(2);
    Serial.println("[TFT] Using built-in font");
    Serial0.println("[TFT] Using built-in font");
#endif
