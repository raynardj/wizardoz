...
If the game jumps too easily or not enough, adjust `VOICE_THRESHOLD` in `src/game/game_engine.h`:
...
voice-jump-game/
├── include/
│   └── pin_config.h          # GPIO definitions (no keypad)
├── src/
...
- [WizardozConnect](https://github.com/livekit/client-sdk-esp32) — BLE/WiFi provisioning (optional, for status icons)
